...
TRACES: dict[str, dict] = {
    ...
    "accent_struggle": {
        ...
        "trace": CallTrace(call_id="live-accent", events=_t(
            {"kind": "say", "t_ms": 0, "text": "Piccino, how can I help?"},
            {"kind": "hear", "t_ms": 1700, "text": "Yes hello, I would like... ehh... table for, this evening",
             "asr_conf": 0.42, "audio": _af(lang="en", speech_rate_wpm=95)},
            {"kind": "say", "t_ms": 2400, "text": "Sure! For how many people?"},
            {"kind": "hear", "t_ms": 3500, "text": "Is, eh, four people... no— [unclear]", "asr_conf": 0.38,
             "audio": _af(lang="en")},
            {"kind": "say", "t_ms": 4200, "text": "Great, a table for four. And what time?"},
            {"kind": "hear", "t_ms": 5200, "text": "Sorry? Can you— say again please?", "asr_conf": 0.61,
             "audio": _af(repeat_request=True)},
